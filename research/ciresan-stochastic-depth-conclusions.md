...
The [main training plots](https://yaroslavvb.github.io/gradient-dissent/ciresan-stochastic-depth/telemetry/) expose 838 scalar fields from 18 verified reruns. The [mask and digit explorer](https://yaroslavvb.github.io/gradient-dissent/ciresan-stochastic-depth/hypotheses/) contains all 16 branch masks and individual examples. The run registry below connects these results to source records and, once authenticated uploads are verified, actual W&B runs.
